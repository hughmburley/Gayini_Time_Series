...
## 04_test_fractional_cover_extraction.R
## -----------------------------------------------------------------------------


## Purpose:
## Test fractional-cover extraction on a small, controlled subset before scaling up.
...
test_extraction_output_path <- file.path(
  ...
  "Output",
  "csv",
  "test_fractional_cover_extraction.csv"
)
...
band_sum_checks_path <- file.path(
  ...
  "Output",
  "diagnostics",
  "test_fractional_cover_band_sum_checks.csv"
)
...
test_checks_path <- file.path(
  ...
  "Output",
  "diagnostics",
  "test_fractional_cover_extraction_checks.csv"
)
...
test_plot_selection_path <- file.path(
  ...
  "Output",
  "diagnostics",
  "test_fractional_cover_selected_plots.csv"
)
...
timeseries_plot_path <- file.path(
  ...
  "Output",
  "figures",
  "test_fractional_cover_plot_timeseries.png"
)
...
valid_count_plot_path <- file.path(
  ...
  "Output",
  "figures",
  "test_fractional_cover_valid_count.png"
)
...
band_sum_plot_path <- file.path(
  ...
  "Output",
  "figures",
  "test_fractional_cover_band_sum_check.png"
)
