# ------------------------------------------------------------------------------
# Script: scripts/02_extract_heavy/internal/01_extract_landsat_inundation_full_impl.R
# Purpose: Internal implementation module for 02_extract_heavy: extract
#          landsat inundation full impl.
