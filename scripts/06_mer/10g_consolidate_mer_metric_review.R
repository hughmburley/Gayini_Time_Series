...
scripts_reviewed <- tibble::tibble(
  script_or_doc = c(
    ...
    "scripts/06_mer/06_extract_MER_inundation_metrics.R",
...
decision_table <- tibble::tribble(
  ...
  "scripts/06_mer/06_extract_MER_inundation_metrics.R", "active script", "keep_active", "workflow step 06", "Clean active driver sourcing R/gayini_mer_inundation_functions.R.", "Should remain RS-only; no gauge dependency.",
