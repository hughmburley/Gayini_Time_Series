...
DEST = ROOT / "Output" / "pack" / "v1_4"
PREV_ZIP = ROOT / "Output" / "Gayini_Adrian_pack_v1.3_20260807.zip"
...
FILES = [
 ...
 ("figures", "Output/figures/PARTREG_S2_residual_map_whole_record.png",
  "Single-page residual map, whole record. The three-panel figure is legible as a set and illegible "
  "one panel at a time; this is the full-width companion, same scale and ticks, residuals labelled."),
 ("figures", "Output/figures/PARTREG_S2_residual_map_cropping_era.png",
  "Single-page residual map, cropping era 1988-2013."),
 ("figures", "Output/figures/PARTREG_S2_residual_map_post_management.png",
  "Single-page residual map, post-management 2018-2022, five water years."),
 ("figures", "Output/figures/FIG2_bootstrap_slope_distributions.png",
  "How far the fitted slope moves when the paddocks are resampled. A methods and questions figure, "
  "not a presentation figure."),
 ("figures", "Output/figures/SCHEM1_figure25_axis_chain.png",
  "How each axis of the cover-and-water figure is built, end to end. Its water column names the "
  "within-year denominator correctly and always did."),
 ("figures", "Output/figures/F5_cover_vs_water_64_paddocks.png",
  "Cover against water, 64 paddocks - methods document Figure 25, with the x-axis and subtitle "
  "corrected under Rulings AZ and AZ-a. THE METHODS DOCUMENT AT V13 STILL CARRIES THE OLD LABEL."),
 ("tables", "Output/diagnostics/tier2H_g1a_annual_veg_valid_seasons.csv",
  "ASSERTED FROM by the ground-cover metadata record: 3.465 usable seasons of 4, 64.6% of cells "
  "with all four, WY1994 at 2.243. v1.3 quoted these and did not ship the table."),
]
...
v12 = f"{sha_full(PREV_ZIP)}" if PREV_ZIP.exists() else "(v1.2 zip not found on disk)"
sup.write_text(
 "# Supersession\n\n"
 ...
 f"| | |\n|---|---|\n| v1.2 seal | `{PREV_ZIP.name}` |\n| v1.2 SHA-256 | `{v12}` |\n"
 f"| v1.3 manifest | `PACKv14_manifest.csv`, {len(rows)} files |\n\n"
