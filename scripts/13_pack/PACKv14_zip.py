...
PACKv14_manifest.csv and writes exactly the files listed there.
...
PACK = ROOT / "Output" / "pack" / "v1_4"
MAN = PACK / "PACKv14_manifest.csv"
EXTRA = ["PACKv14_manifest.csv", "SUPERSESSION.md"]
OUT = ROOT / "Output" / "Gayini_Adrian_pack_v1.4_20260807.zip"
...
with zipfile.ZipFile(OUT, "w", zipfile.ZIP_DEFLATED, compresslevel=6) as z:
    for p in sorted(members, key=lambda q: q.relative_to(PACK).as_posix()):
        z.write(p, f"Gayini_Adrian_pack_v1.4/{p.relative_to(PACK).as_posix()}")
