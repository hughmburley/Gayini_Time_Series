# ------------------------------------------------------------------------------
# Script: scripts/03_inundation_products/internal/04_join_rs_and_gauge_timeseries_impl.R
# Purpose: Internal implementation module for 03_inundation_products: join rs
#          and gauge timeseries impl.
