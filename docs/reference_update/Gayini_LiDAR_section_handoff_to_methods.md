...
- **A stable-ground test was mandatory before any change number.** It produced a numeric floor below
  which nothing is claimed. The 2021 first-return density is **1.4672**, about 38% above 2009 — a
  real instrument difference, and a test for whether it could be corrected for found **no derivable
  correction**.
