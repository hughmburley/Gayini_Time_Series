...
**Supersedes** `Gayini_report_batch_CC_handoff.md` dated 29 July, which was written before
T10 Gate D and REG-1 registered the expectation apparatus. Discard that one.
